        ...
        openerp.Tour.register({
            ...
            steps: [
                ...
                },
                {
                    ...
                    element: 'div.oe_sale_acquirer_button:not(.hidden) form[action="/payment/transfer/feedback"] .btn[type="submit"]',
                ...
                },
                {
                    ...
                    waitFor: 'form[action="/shop/checkout"] .has-error',
                    element: 'div.oe_sale_acquirer_button:not(.hidden) form[action="/payment/transfer/feedback"] .btn[type="submit"]',
                    onload: function (tour) {
...

                {
                    //step 6
                    title: "finish",
                    waitFor: '.oe_website_sale_tx_status',
                }
            ]
        });
